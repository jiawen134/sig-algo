...
public class Parameters {
  ...
  //---TEAM-A-PARAMETERS---//
  //-----------------------//
  public static final String teamAName = "Aegis Legion";
  //public static final String teamAMainBotBrainClassName = "algorithms.AegisMain"; //class given by name; is supposed to extends robotsimulator.Brain
  public static final String teamAMainBotBrainClassName = "algorithms.MagicMain";
  ...
  //public static final String teamASecondaryBotBrainClassName = "algorithms.SwiftScout"; //class given by name; is supposed to extends robotsimulator.Brain
  public static final String teamASecondaryBotBrainClassName = "algorithms.MagicSecondary";
